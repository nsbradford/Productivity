...
* **Computer directory organization**: here's the general structure I use. Note that I use "Archive" folders in various places to separate things that I'm not actively working on.
```
   ~/Documents
      /dev
        /localdev
